...
| 6 | Fleet Dashboard (Bet 3) | `/insights` page, aggregation queries/views, export | complete | - | 2, 4, 5 | [.claude/PRPs/plans/completed/fleet-dashboard.plan.md](../plans/completed/fleet-dashboard.plan.md) → [report](../reports/fleet-dashboard-report.md) |
